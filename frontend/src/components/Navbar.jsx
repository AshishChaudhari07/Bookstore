    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
                ...
                <div className="navbar bg-base-100 dark:bg-slate-900 dark:bg dark:text-white">
                            ...
                            <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
                                <svg
                                    ...
                                    <path
                                        ...
                                        strokeWidth="2"
                                        d="M4 6h16M4 12h8m-10 6h16" />
                                </svg>
                            </div>
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                                {/*  this is use in small screen ex.phone */}
                                {navItem}
                            </ul>
                        </div>
                        ...
                        <div>
                            <label className="swap swap-rotate">
                                ...
                                <svg
                                    ...
                                    <path
                                        d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,10.15,0,0,1,9.08,5.49a8.59,10.59,0,0,1,.25-2A1,1,0,0,0,10,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,10.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,10.11,0,0,1,12.14,19.73Z" />
                                </svg>
                            </label>
                        </div>
